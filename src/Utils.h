...
public:
    Utils() = delete;
    static std::string Subchar(const char* source, int start, int end);
    static std::string ValueDecoder(char *buffer, jsmntok_t *tokens, int start, int finish,  const char* property);
